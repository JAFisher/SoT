...
If you use SoT in your project, please credit:
- **Author:** JAFisher
- **Project:** SoT Engine (Single Oriented Transformation)
- **Repository:** https://github.com/JAFisher/SoT


## Citation

If you use SoT in academic work:
```bibtex
@software{jafisher2026sot,
  author = {JAFisher},
  title = {SoT Engine: Single Oriented Transformation},
  url = {https://github.com/JAFisher/SoT},
  year = {2026}
}
